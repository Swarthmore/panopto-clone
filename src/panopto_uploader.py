...
class PanoptoUploader:
    ...
    def get_child_folders(self, folder_id, page_number = 0, sort_order = "Desc", sort_field = "Name"):
        """
    ...
    def create_folder(self, folder_name, folder_id, folder_description = None):
        """
